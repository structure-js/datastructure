(function () {
    ...
    BinarySearchTree.prototype.insert = function (value) {
        ...
        this.root = this.insert2(this.root, value);
    ...
    BinarySearchTree.prototype.insert2 = function (node, value) {
        ...
        if(cmp > 0){
            let newNode = this.insert2(node.getLeft(), value);
            newNode.setParent(node);
            node.setLeft(newNode);
        }else if(cmp < 0){
            let newNode = this.insert2(node.getRight(), value);
            newNode.setParent(node);
    ...
    BinarySearchTree.prototype.delete = function (value) {
        ...
        this.setRoot(this.delete2(this.root, value));
    ...
    BinarySearchTree.prototype.delete2 = function (node, value) {
        if(node===null){
            return null;
        }
        if (this.compare(value, node.value) < 0) {
            ...
            node.setLeft(this.delete2(node.getLeft(), value));
        } else {
            if (isRed(node, LEFT)) {
                node = this.rotateRight(node);
            }
            ...
            if (this.compare(value, node.value) === 0) {
                ...
                node.setRight(this.deleteMin2(node.getRight()));
            } else {
                node.setRight(this.delete2(node.getRight(), value));
            }
        }
    ...
    BinarySearchTree.prototype.deleteMin = function(){
        ...
        this.root = this.deleteMin2(this.root);
        if (!this.isEmpty()) {
            this.root.color = BLACK;
        }
    }
    BinarySearchTree.prototype.deleteMin2 = function(node){
        ...
        node.setLeft(this.deleteMin2(node.getLeft()));
        return this.balance(node);
    }
    ...
    BinarySearchTree.Node.prototype.isRed = function () {
